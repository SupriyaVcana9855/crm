...
*
*/
define('APP_BASE_URL', 'https://vcanaglobal.io/vcanacrm/');
...
*/
define('APP_ENC_KEY', '5faa08c5c2cc63e440ef0ee8f176f05c');
 ...
 */
define('APP_DB_USERNAME', 'vcanaglobal_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'vcanaglobal_crm');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'vcanaglobal_crm');
